...
export const LIST_ITEM_LIMIT = Number.isNaN(
...
export const CONCURRENCY = Number.isNaN(Number(process.env.CONCURRENCY))
  ? 5
...
export const LIST_NAME_PREFIX = "CFGSL List";

export const RULE_NAME = "CFGSL Filter Lists";
